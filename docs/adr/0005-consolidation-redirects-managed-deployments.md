...
Accepted. Supersedes partial ADR 0004.

## Context

Consolidation Batch 在替换权威 Canonical 内容时，若任由受管部署继续指向被归档的旧 Candidate Source，清单（manifest 指向 canonical）与文件系统（目标指向旧 candidate）会立刻漂移，整理原子性也就失去了意义。
